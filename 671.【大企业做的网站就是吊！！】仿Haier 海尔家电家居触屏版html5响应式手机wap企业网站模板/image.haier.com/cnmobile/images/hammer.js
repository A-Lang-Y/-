...
function Hammer(element, options, undefined)
{
    ...
    var gestures = {
        ...
        tap : function(event)
        {
            ...
            var is_double_tap = (function(){
                ...
                {
                    if (typeof _prev_tap_pos[0] == "undefined" ){
                        return false;
                    }
                    if ( typeof _pos == "undefined" || typeof _pos.start == "undefined" || typeof _pos.start[0] == "undefined") {
                        return false;
                    }
    ...
    function handleEvents(event)
    {
        switch(event.type)
        {
            ...
            case 'touchmove':
                // 阻止事件默认动作
                if (typeof event.preventDefault == 'function' && options.preventTouchmove === true) {
                    event.preventDefault();
                }
                var count = countFingers(event);
    ...
    // add removeEvent to obj liw add
