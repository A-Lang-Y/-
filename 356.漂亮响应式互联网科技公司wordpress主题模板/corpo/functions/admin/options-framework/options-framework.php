...
function optionsframework_load_scripts($hook) {
	...
	if ( !wp_script_is( 'wp-color-picker', 'registered' ) ) {
		...
		$colorpicker_l10n = array(
			'clear' => __( 'Clear', 'corpo' ),
			'defaultString' => __( 'Default', 'corpo' ),
			'pick' => __( 'Select Color', 'corpo' )
		);
...
function optionsframework_page() {
	settings_errors(); ?>
    <?php $theme = wp_get_theme(); if ( $theme->name == 'Corpo' ) : ?>
    <div id="optionsframework-themepromo">
        <h2><?php _e('Upgrade to Corpo Pro!','corpo'); ?></h2>
        <p><?php _e('All Corpo features plus <b>custom typography, unlimited colors, filterable portfolio</b> and more!','corpo'); ?> <a href="http://webtuts.pl/corpo-pro/"><?php _e('Buy now!','corpo'); ?></a></p>
	</div>
    <?php endif; ?>
