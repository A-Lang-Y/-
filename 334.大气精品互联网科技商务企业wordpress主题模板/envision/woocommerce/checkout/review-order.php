...
<div id="order_review">
	...
	<table class="shop_table ui--box">
		...
		<tfoot>
			...
			<tr class="ui--gradient ui--gradient-grey cart-subtotal">
			...
			<tr class="ui--gradient ui--gradient-grey total">
	...
	<div id="payment">
			...
			<?php
				...
				if ( ! empty( $available_gateways ) ) {
					...
					foreach ( $available_gateways as $gateway ) {
						?>
						<li class="ui--box ui--gradient ui--gradient-grey payment_method_<?php echo $gateway->id; ?>">
		...
		<div class="form-row place-order">
			...
			echo apply_filters( 'woocommerce_order_button_html', '<button type="submit" class="btn btn-block btn-primary" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" >' . esc_attr( $order_button_text ) . '</button>' );
			?>
