...
<form class="shipping_calculator" action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form-no-hide">
		...
		<p class="form-row form-row-wide">
			<?php
				...
				// Dropdown Input
					...
					?><span>
						<select name="calc_shipping_state" id="calc_shipping_state" class="no-uniform" placeholder="<?php _e( 'State / county', 'woocommerce' ); ?>">
